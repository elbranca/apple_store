<template>
    <div class="homepage">
      <div class="homepage__wrapper">
        <h1 class="homepage__title">Apple Store</h1>
        <p class="homepage__description">Add, sign and search.</p>
...
<style scoped>
  ...
  .homepage__buttons-wrapper button{
  ...
  .homepage__buttons-wrapper button:hover{
    cursor: pointer;
  }
